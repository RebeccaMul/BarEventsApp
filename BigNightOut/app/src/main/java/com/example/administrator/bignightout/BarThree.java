...
public class BarThree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.barthreeaboutlayout);
    ...
    public void fbClick(View view) {
        ...
        Link.setData(Uri.parse("https://www.facebook.com/cuckoobelfast"));
    ...
    public void twitClick(View view) {
        ...
        Link.addCategory(Intent.CATEGORY_BROWSABLE);
        //Setting Link intent's URL
        Link.setData(Uri.parse("https://twitter.com/cuckoobelfast1"));
        //Starting intent (redirecting to URL)
        startActivity(Link);
    ...
    public void instaClick(View view) {
        ...
        Link.addCategory(Intent.CATEGORY_BROWSABLE);
        //Setting Link intent's URL
        Link.setData(Uri.parse("https://www.instagram.com/cuckoobelfast1/"));
        //Starting intent (redirecting to URL)
        startActivity(Link);
