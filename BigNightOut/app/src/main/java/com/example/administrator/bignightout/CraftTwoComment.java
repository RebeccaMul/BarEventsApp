...
public class CraftTwoComment extends AppCompatActivity {
    ...
    String url = "http://rmulholland15.students.cs.qub.ac.uk/craftbeerthree.php";
    String TAG = CraftTwoComment.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_craft_two_comment);
    ...
    public void commentClick(View view) {
        Intent menu4Link = new Intent(this, CraftTwoLeaveComment.class);
    ...
    private class GetComments extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(CraftTwoComment.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            SimpleAdapter adapter = new SimpleAdapter(CraftTwoComment.this, commentList,
