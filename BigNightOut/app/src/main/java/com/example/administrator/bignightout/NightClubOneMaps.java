...
public class NightClubOneMaps extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nightclubonemapslayout);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(new LatLng(54.587941, -5.934178)).title("The Fly"));
    ...
    private void enableAccelerometerListening() {
        ...
        if (stepSensor == null){
            Toast.makeText(NightClubOneMaps.this,
