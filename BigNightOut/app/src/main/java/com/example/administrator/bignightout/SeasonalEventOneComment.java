...
public class SeasonalEventOneComment extends AppCompatActivity {
    ...
    String url = "http://rmulholland15.students.cs.qub.ac.uk/seasonaleventsone.php";
    String TAG = SeasonalEventOne.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.seasonaleventonecommentlayout);
    ...
    public void commentClick(View view) {
        Intent menu4Link = new Intent(this, SeasonalEventOneLeaveComment.class);
    ...
    private class GetComments extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(SeasonalEventOneComment.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            SimpleAdapter adapter = new SimpleAdapter(SeasonalEventOneComment.this, commentList,
