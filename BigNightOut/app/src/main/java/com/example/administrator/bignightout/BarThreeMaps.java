...
public class BarThreeMaps extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.barthreemapslayout);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(new LatLng(54.583359, -5.945289)).title("Cuckoo"));
    ...
    private void enableAccelerometerListening() {
        ...
        if (stepSensor == null){
            Toast.makeText(BarThreeMaps.this,
