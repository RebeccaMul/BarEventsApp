...
public class SeasonalEventOneMaps extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.seasonalonemapslayout);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(new LatLng(54.59672, -5.93002)).title("Christmas Market"));
    ...
    private void enableAccelerometerListening() {
        ...
        if (stepSensor == null){
            Toast.makeText(SeasonalEventOneMaps.this,
