...
public class NightClubTwoComment extends AppCompatActivity {
    ...
    String url = "http://rmulholland15.students.cs.qub.ac.uk/nightclubtwo.php";
    String TAG = NightClubTwoComment.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.nightclubtwocommentlayout);
    ...
    public void AboutRedirect(View view) {
        Intent menuLink = new Intent(this, NightClubTwo.class);
        startActivity(menuLink);
    }

    public void MapsRedirect(View view) {
        Intent menu2Link = new Intent(this, NightClubTwoMaps.class);
        startActivity(menu2Link);
    }

    public void CommentsRedirect(View view) {
        Intent menu3Link = new Intent(this, NightClubTwoComment.class);
        startActivity(menu3Link);
    }

    public void commentClick(View view) {
        Intent menu4Link = new Intent(this, NightClubTwoLeaveComment.class);
    ...
    private class GetComments extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(NightClubTwoComment.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            SimpleAdapter adapter = new SimpleAdapter(NightClubTwoComment.this, commentList,
