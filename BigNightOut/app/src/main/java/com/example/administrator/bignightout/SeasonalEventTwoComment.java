...
public class SeasonalEventTwoComment extends AppCompatActivity {
    ...
    String url = "http://rmulholland15.students.cs.qub.ac.uk/seasonaleventstwo.php";
    String TAG = SeasonalEventTwo.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.seasonaleventtwocommentlayout);
    ...
    public void commentClick(View view) {
        Intent menu4Link = new Intent(this, SeasonalEventTwoLeaveComment.class);
    ...
    private class GetComments extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(SeasonalEventTwoComment.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            SimpleAdapter adapter = new SimpleAdapter(SeasonalEventTwoComment.this, commentList,
