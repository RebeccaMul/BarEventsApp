...
public class NightClubOneComment extends AppCompatActivity {
    ...
    String url = "http://rmulholland15.students.cs.qub.ac.uk/nightclubone.php";
    String TAG = NightClubOneComment.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.nightclubonecommentlayout);
    ...
    public void AboutRedirect(View view) {
        Intent menuLink = new Intent(this, NightClubOne.class);
        startActivity(menuLink);
    }

    public void MapsRedirect(View view) {
        Intent menu2Link = new Intent(this, NightClubOneMaps.class);
        startActivity(menu2Link);
    }

    public void CommentsRedirect(View view) {
        Intent menu3Link = new Intent(this, NightClubOneComment.class);
        startActivity(menu3Link);
    }

    public void commentClick(View view) {
        Intent menu4Link = new Intent(this, NightClubOneLeaveComment.class);
    ...
    private class GetComments extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(NightClubOneComment.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            SimpleAdapter adapter = new SimpleAdapter(NightClubOneComment.this, commentList,
