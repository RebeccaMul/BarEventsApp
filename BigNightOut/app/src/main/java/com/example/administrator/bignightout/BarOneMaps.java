...
public class BarOneMaps extends FragmentActivity implements OnMapReadyCallback {
    ...
    //Rebecca - Values for calculation of number of steps:
    float currentY;
    float previousY;
    int numSteps;
    int threshold;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.baronemapslayout);
        // Obtain the SupportMapFragment and get notified when the map is ready to be used.
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.map);
        mapFragment.getMapAsync(this);

        //Initialising the buttons with existing button ids:
        ...
        //Rebecca -Setting up threshold (when a step triggers)
        threshold = 10;
        previousY =0;
        numSteps = 0;

        //Rebecca - Calling step counter method
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(new LatLng(54.589015, -5.934424)).title("Laverys"));
    ...
    //Rebecca - Step counter method, uses accelerometer to detect user's steps/motions when using the map feature
    private void enableAccelerometerListening() {
        ...
        if (stepSensor == null){
            Toast.makeText(BarOneMaps.this,
