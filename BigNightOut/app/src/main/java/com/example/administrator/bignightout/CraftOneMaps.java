...
public class CraftOneMaps extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(new LatLng(54.575609, -5.917336)).title("Brewbot"));
    ...
    private void enableAccelerometerListening() {
        ...
        if (stepSensor == null){
            Toast.makeText(CraftOneMaps.this,
