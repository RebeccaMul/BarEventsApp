...
public class NightClubTwoMaps extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nightclubtwomapslayout);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(new LatLng(54.601107, -5.925641)).title("Ollies"));
    ...
    private void enableAccelerometerListening() {
        ...
        if (stepSensor == null){
            Toast.makeText(NightClubTwoMaps.this,
